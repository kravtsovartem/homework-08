...
export const taskListSlice = createSlice({
	...
	reducers: {
		...
		toggleFilterClosedTask(state) {
			state.isShowClosedTask = !state.isShowClosedTask
		}
	},
});
...
export const isShowClosedTask = (state: RootState) =>
	state.taskList.isShowClosedTask